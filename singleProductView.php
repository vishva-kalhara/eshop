...
if (isset($_GET["id"])) {
    ...
    product.category_cat_id,product.model_has_brand_id,product.color_clr_id,product.status_id,
    product.condition_id,product.user_email,model.model_name AS mname,
