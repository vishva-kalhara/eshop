                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-4 mb-3">
                                        <select class="form-select" id="b1">
                                            ...
                                            ?>
                                                ...
                                                <option value="<?php echo $category_data["brand_id"]; ?>">
                                    ...
                                    <div class="col-12 col-lg-4 mb-3">
                                        <select class="form-select" id="m">
                                            ...
                                            $category_rs = Database::search("SELECT * FROM `model`");
                                            $category_num = $category_rs->num_rows;
                                            ...
                                            ?>
                                                ...
                                                <option value="<?php echo $category_data["model_id"]; ?>">
                                                    <?php echo $category_data["model_name"]; ?>
                                                </option>
                                    ...
                                    <div class="col-12 col-lg-6 mb-3">
                                        <select class="form-select" id="c2">
                                            ...
                                            $category_rs = Database::search("SELECT * FROM `condition`");
                                            $category_num = $category_rs->num_rows;
                                    ...
                                    <div class="col-12 col-lg-6 mb-3">
                                        <select class="form-select" id="c3">
                                            ...
                                            $category_rs = Database::search("SELECT * FROM `color`");
                                            $category_num = $category_rs->num_rows;
